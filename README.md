...
- 🎓 Pursuing Master of Computer Applications (MCA) at NIT Allahabad, Prayagraj (CPI: 9.08)
- 💻 Passionate about Web Development and exploring AI/ML
- 🏆 Secured All India Rank 168 in NIMCET
- 🧩 Solved 1000+ DSA problems on LeetCode, Codeforces & GeeksforGeeks
- 🌱 Currently learning: DSA in Java, exploring LLMs & RAG systems
- 📫 Reach me: [LinkedIn](https://www.linkedin.com/in/gurpreet-kaur-86889331b/)
...
**🩺 [Medi-Friend](https://github.com/suchismita102/MediFriend)**
...
**📄 [DocuMind AI](https://github.com/Gurpreetkaur2111/DocuMind_AI)**

A RAG-based multi-PDF question-answering system enabling natural language querying across documents using semantic search and LLM integration.

**Tech:** Python · LangChain · FAISS · HuggingFace · Groq API
